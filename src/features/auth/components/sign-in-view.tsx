...
//   return (
//     <div className='grid h-screen lg:grid-cols-2 p-2 bg-background'>
//       {/* Left Panel - Background Image and Content */}
//       <div className=' p-4 flex-1 flex'>


//         <div
//           className='relative hidden lg:flex flex-col rounded-[20px]  bg-muted p-10 justify-end overflow-hidden'  // Changed justify-between to justify-end
//           style={{
